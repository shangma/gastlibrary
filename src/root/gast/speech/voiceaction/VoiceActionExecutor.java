...
public class VoiceActionExecutor
{
     ...
     */
    public static final String EXECUTE_AFTER_SPEAK = "EXECUTE_AFTER_SPEAK";
    public static final String END_OF_QUERY_SPEAK = "END_OF_QUERY_SPEAK";
    ...
    public void speak(String toSay, String paramString)
    {
        tts.speak(toSay, TextToSpeech.QUEUE_FLUSH, TextToSpeechUtils.makeParamsWith(paramString));
    }
